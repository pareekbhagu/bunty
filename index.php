<?php echo "<html xmlns="http://www.w3.org/1999/xhtml" lang="en">" ; ?>
			...
			<div class="wrapper header">
				<div class="clearfix header_top">
					<div class="clearfix logo floatleft">
						<a href="">
						<img src="images/photos/logo.jpg" />
						</a>
					</div>
				...
				<div class="header_bottom">
					<nav>
						<ul id="nav">
							...
							<li id="dropdown"><a href="">Replacement Parts</a>
								<ul>
									<li><a href="">Home</a></li>
			...
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix slider">
						<ul class="pgwSlider">
							<li><img src="images/thumbs/megamind_06.jpg" alt="Paris, France" data-description="Eiffel Tower and Champ de Mars" data-large-src="images/slides/megamind_06.jpg"/></li>
					...
					<div class="clearfix content">
						<div class="content_title"><h2>Welcome to FRIENDS Communication</h2></div>
						...
						<div class="clearfix single_content">
							...
							<div class="clearfix post_detail">
								<h2><a href="">Used Laptops for Sale in Surrey</a></h2>
								...
								<div class="clearfix post_excerpt">
									...
									<p>Nowadays, personal computers and laptops have become an indispensable necessity for our homes and workplaces. Be it an office or school work, it is impossible to accomplish our daily assignments and keep in touch with the world without a computer. We have a variety of compelling used laptop for sale deals available, often it gets really confusing to choose a best suitable option being within budget, but our deals are comparatively much more affordable.
</p>
								</div>
					...
					<div class="clearfix sidebar">
						<div class="clearfix single_sidebar">
							<div class="popular_post">
								<div class="sidebar_title"><h2>Hot Service offers by FRIENDS</h2></div>
								<ul>
									<li><a href="">Repair LCD of your Laptop just for $120.00 </a></li>
									<li><a href="">Buy Battery for Iphone 6 for  $120.00 </a></li>
									<li><a href="">Buy New Sennheiser(misspelt?)earphones for just $120.00 </a></li>
									<li><a href="">Repair LCD of your Laptop just for $120.00 </a></li>
									<li><a href="">Buy Mobile case for samsung Galaxy for $25.00 </a></li>
								</ul>
							</div>
							</div>
		...
		<section id="footer_bottom_area">
			<div class="clearfix wrapper footer_bottom">
				<div class="clearfix copyright floatleft">
					<p> Copyright &copy; All rights reserved by <span>friendscommunications.ca</span></p>
				</div>
